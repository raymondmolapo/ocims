...
dcat_json_interface raymond_theme viewhelpers dashboard_preview navigablemap datajson_harvest spatial_metadata spatial_query',
	'line' : True
    }
...
ckanext.spatial.search_backend = solr',
    ...
    data['debug ='] = {
	'value':'debug = false\n\n[app:celery]\nBROKER_BACKEND = redis\nBROKER_HOST = redis://146.64.19.62/1\n\
CELERY_RESULT_BACKEND = redis\nREDIS_HOST = 146.64.19.62\nREDIS_PORT = 6379\nREDIS_DB = 0\n\
